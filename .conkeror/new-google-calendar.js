...
define_key(google_calendar_keymap, "C-c c", null, $fallthrough);
define_key(google_calendar_keymap, "c", "copy");//BAD
...
//define_key(google_calendar_keymap, "q", "kill-current-buffer");
//define_key(google_calendar_keymap, "C-c q", null, $fallthrough);
//define_key(google_calendar_keymap, "q", "kill-current-buffer");
//define_key(google_calendar_keymap, "C-c q", "kill-current-buffer");
...
define_page_mode("google_calendar_mode",
                 $display_name = "New Google Calendar",
                 $enable = function (buffer) {
                   add_hook.call(buffer, "buffer_dom_content_loaded_hook",
                                 google_calendar_modality);
                   add_hook.call(buffer, "unfocus_hook", google_calendar_modality);
                   buffer.modalities.push(google_calendar_modality);
                 },
                 $disable = function (buffer) {
                   remove_hook.call(buffer, "buffer_dom_content_loaded_hook",
                                    google_calendar_modality);
                   remove_hook.call(buffer, "unfocus_hook", google_calendar_modalityc);
