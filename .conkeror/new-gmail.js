...
// Jumping
define_key(gmail_keymap, "C-c g", null, $fallthrough);
...
// Application
define_key(gmail_keymap, "C-c c", null, $fallthrough);
define_key(gmail_keymap, "C", null, $fallthrough);
define_key(gmail_keymap, "/", null, $fallthrough);
define_key(gmail_keymap, "C-c q", null, $fallthrough);
define_key(gmail_keymap, "?", null, $fallthrough);
...
define_key(gmail_keymap, "#", null, $fallthrough);
define_key(gmail_keymap, "C-c r", null, $fallthrough);
define_key(gmail_keymap, "C-c f", null, $fallthrough);
define_key(gmail_keymap, "N", null, $fallthrough);
define_key(gmail_keymap, ".", null, $fallthrough);
define_key(gmail_keymap, "I", null, $fallthrough);
define_key(gmail_keymap, "U", null, $fallthrough);
